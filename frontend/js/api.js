...
var USER    = null;
var REFS    = {operations:[],machines:[],objectTypes:[],units:[],coatings:[],materials:[],assortments:[]};
var ARC     = [];
var ARC_SEL = -1;
var OPS_PAGE = 1;
var OPS_SEARCH_T = null;
var acTimers = {};
try { USER = JSON.parse(localStorage.getItem('cir_user') || 'null'); } catch(e) {}
